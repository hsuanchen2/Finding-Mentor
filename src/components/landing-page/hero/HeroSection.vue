    ...
    <section class="hero-section container">
        <div class="row">
            <div class="hero-text col-lg-6 col-md-12">
                ...
                <p>
                    We have successfully matched over a thousand career consultations, guiding individuals on their
                ...
                <div class="hero-section-cta-button">
                    ...
                    <router-link to="/auth" class="hero-register"><span>Register <i
                                class="fas fa-arrow-right"></i></span></router-link>
                </div>
            </div>
            <div class="hero-image-container col-lg-6 col-md-12">
                ...
                <img src="../../../../public/index/test.svg" alt="profession" class="hero-image-miner-second"
                    data-aos="fade-up" data-aos-delay="600" data-aos-easing="ease-in-out" />
            </div>
        </div>
    </section>
</template>
