<template>
    <section class="container">
        <div class="top-mentors-copy">
            ...
            <p>At our service, you'll find a vast network of professionals, numbering over 1000,
                from various
                industries.
        ...
        <Splide ref="splide" :options="splideSettings" aria-label="Senpai Card">
            <SplideSlide v-for="mentor in userArray" :key="mentor.userId" class="splide__slide">
                <mentor-card :userId="mentor.userId" :jobTitle="mentor.jobTitle" :userName="mentor.userName"
                    :desc="mentor.desc" :rate="mentor.rate" :jobRating="mentor.jobRating">
                </mentor-card>
            </SplideSlide>
        </Splide>
        <div class="button-group">
            <button @click="btnPrev"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
                    <path d="m12.718 4.707-1.413-1.415L2.585 12l8.72 8.707 1.413-1.415L6.417 13H20v-2H6.416l6.302-6.293z" />
                </svg></button>

            <button @click="btnNext"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="flip">
                    <path d="m12.718 4.707-1.413-1.415L2.585 12l8.72 8.707 1.413-1.415L6.417 13H20v-2H6.416l6.302-6.293z" />
                </svg></button>
        </div>
    </section>
