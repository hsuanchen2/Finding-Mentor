                ...
                <div class="col col-12 col-xl-7 cards-container">
                    <div class="row">
                        ...
                        <div class="container toggle-buttons">
                            <div class="row">
                                <img :class="{ 'col': true, 'col-3': true, 'active': index === show }"
                                    v-for="(button, index) in buttons" :src="button.buttonUrl" :alt="button.alt"
                                    @click="toggle(index)" :key="index" />
                            </div>
                        </div>
                    </div>
                </div>
...
const imageData = ref([
    ...
    },
    {
        alt: "resume-review",
        imgUrl:
            "@/../public/index/resume-review.png",
