    ...
    <section class="container">
      <div class="row">
        <div class="col col-12 col-lg-5">
          <service-copy :textStart="copies[imgIndex].textStart" :h2="copies[imgIndex].h2"
            :copy="copies[imgIndex].copy" :list="copies[imgIndex].lis"></service-copy>
        </div>
        <div class="col col-12 col-lg-7 cards-container">
          <div class="row">
            <genre-card class="col col-12" :src="imageData[imgIndex].imgUrl" :copy="imageData[imgIndex].copy"
               :alt="imageData[imgIndex].alt"></genre-card>
            <!-- toggle buttons -->
