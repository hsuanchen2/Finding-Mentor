  ...
  <section class="search-result">
    <div class="text-wrapper">
      ...
      <span @click="toggleSidebar">
        <button class="search-bar-toggle hidden">
          <i class="fa-solid fa-sliders" style="color: #635bff"></i></button
      ></span>
      <div class="search-tags">
        <search-tag :searchCriteria="props.searchCriteria"></search-tag>
        <span
          v-if="searchCriteriaExists"
          class="clear-filter"
          @click="reSearchMentor"
          >Clear filters</span
        >
      </div>
    </div>
    <div class="user-card-container">
      ...
      <user-card
        v-if="!isMentorsListEmpty"
        v-for="result in props.searchResult"
        :id="result.id"
...
const currentCartIds: Ref<string[]> = ref([]);
...
// const getIds = (): void => {
//   const ids = store.getters["cart/getCartItems"].map((el) => el.userId);
//   currentCartIds.value = [...ids];
// };
